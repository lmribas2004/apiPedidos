...
public interface OutboxMessageRepository extends JpaRepository<OutboxMessage, Long> {
	/**
	 * Método de consulta com JPQL que retorne todos os registros de mensagens que não foram 
	 * transmitidos de um determinado evento
	 * 
	 * (Só retorna os dados, sem metadados de paginação)  
	*/
	@Query("""
