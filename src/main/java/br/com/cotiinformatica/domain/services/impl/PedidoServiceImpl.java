...
public class PedidoServiceImpl implements PedidoService {
	...
	private final PedidoRepository pedidoRepository; // será injetado por padrão
	private final ModelMapper mapper; // será injetado (foi configurado via @Configuration)
