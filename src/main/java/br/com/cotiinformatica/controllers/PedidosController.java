...
public class PedidosController {
	...
	@PutMapping("{id}")    // /api/v1/pedidos/{id}  { ... }   (id faz parte da composição do endereço desta forma)
	public ResponseEntity<PedidoResponseModel> put(
	...
	@Operation(
			summary = "Inativação de solicitação de pedido.",
